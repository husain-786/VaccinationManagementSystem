...
import com.husain.vaccination.service.AppointmentService;
...
//        System.out.println("Appointment Controller1!!!");
        try {

            String response = appointmentService.bookAppointment(appointmentDto);
